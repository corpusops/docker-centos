...
CENTOS_SKIPPED_TAGS="library/centos:(latest|7|8|6\..*|3|5|2|1|.\..\.....|centos.\..\.....|centos(7|8|6|5).*)|tgagor/centos:(.*(10|development).*|[0-9]+\.|centos([0-9]+\.))"
...
# does not reach stable yet
# tgagor/centos/10     tgagor/centos/stream10::30
BATCHED_IMAGES="\
tgagor/centos/latest tgagor/centos/stream::30
tgagor/centos/9      tgagor/centos/stream9::30
tgagor/centos/8      tgagor/centos/centos8 tgagor/centos/stream8::30
tgagor/centos/7      tgagor/centos/centos7::30
"
